...
// Version: 1.0
// Component call: <SingleActivity mainTitle="Hour" totalVisitors="200" totalMoney="$50,00" percent="+5%"><FaClock className="text-3xl dark:text-blackPrimary text-whiteSecondary" /></SingleActivity>
        ...
        <div>
            <div className='flex justify-between items-center w-full gap-x-16 max-[440px]:flex-col max-[440px]:gap-1 max-[440px]:items-start max-[440px]:w-44'>
                <div className='flex items-center gap-x-4 max-[440px]:flex-col max-[440px]:gap-1'>
                    <div className='flex items-center justify-center w-12 h-12 dark:bg-whiteSecondary bg-blackPrimary'>
                        {children}
                    </div>
                    <div>
