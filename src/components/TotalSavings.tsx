...
const TotalSavings = ({ isPositive, percentage }: { percentage: string; isPositive: boolean }) => {
    return (
        <div className='px-5 py-3 mt-5 border dark:bg-gray-900 bg-whiteSecondary border-blackPrimary'>
