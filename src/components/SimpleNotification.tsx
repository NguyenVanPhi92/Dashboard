...
const FollowNotification = ({
    ...
    return (
        <div className='flex items-center justify-between px-5 py-5 dark:bg-black bg-white/30'>
            {/* left */}
            ...
            <div className='flex flex-col items-end gap-2'>
                <div className='w-3 h-3 bg-blue-700 rounded-full dark:bg-blue-500'></div>
