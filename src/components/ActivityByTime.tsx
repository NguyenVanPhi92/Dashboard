        ...
        <div>
            ...
            <div className='w-full flex flex-col gap-y-4 max-[440px]:grid max-[440px]:grid-cols-2 max-[390px]:grid-cols-1'>
                <SingleActivity
                    ...
                    percent='+5%'
                >
                    <FaClock className='text-3xl dark:text-blackPrimary text-whiteSecondary' />
                </SingleActivity>
                <SingleActivity
                    mainTitle='Daily'
                    totalVisitors='1,200'
                    ...
                    percent='+5%'
                >
                    <FaCalendarDay className='text-3xl dark:text-blackPrimary text-whiteSecondary' />
                </SingleActivity>
                <SingleActivity
                    mainTitle='Weekly'
                    totalVisitors='8,400'
                    ...
                    percent='+10%'
                >
                    <FaCalendarWeek className='text-3xl dark:text-blackPrimary text-whiteSecondary' />
                </SingleActivity>
                <SingleActivity
                    mainTitle='Monthly'
                    ...
                    percent='+15%'
                >
                    <FaCalendarDays className='text-3xl dark:text-blackPrimary text-whiteSecondary' />
                </SingleActivity>
                <SingleActivity
                    mainTitle='Yearly'
                    ...
                    percent='+20%'
                >
                    <FaCalendar className='text-3xl dark:text-blackPrimary text-whiteSecondary' />
                </SingleActivity>
                <SingleActivity
                    mainTitle='Lifetime'
                    ...
                    percent='+44%'
                >
                    <FaAsterisk className='text-3xl dark:text-blackPrimary text-whiteSecondary' />
                </SingleActivity>
            </div>
        </div>
    )
